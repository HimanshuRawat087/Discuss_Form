defmodule DiscussWeb.CoreComponents do
  ...
  def label(assigns) do
    ~H"""
    <label for={@for} class="block text-4xl font-semibold leading-6 text-zinc-800">
      <%= render_slot(@inner_block) %>
    </label>
    """
  end
  ...
  def error(assigns) do
    ~H"""
    <p class="help-block mt-3 flex gap-3 text-sm leading-6 text-rose-600 phx-no-feedback:hidden">
